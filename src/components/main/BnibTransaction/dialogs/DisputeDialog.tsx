...
import { disputeBnibTransactionByCode } from "src/store/bnib-transaction";
...
function DisputeDialog(props: IComponentProps) {
  ...
  const submit = React.useCallback(async () => {
    ...
    const [err] = await goPromise<void>(
      disputeBnibTransactionByCode(transactionCode, reason)
    );
    setLoading(false);
    ...
    if (err) {
      ...
      onAfterSubmit();
      dismiss();
      snackbar.showMessage("Bnib Transaction Product disputed.");
    }
