  ...
  const handleSave = React.useCallback(
    async (formValues: IFormProps) => {
      ...
      const [err] = await goPromise(
        updateLegitCheckDetail(initialValues, formValues)
      );
      setLoading(false);
      if (err) {
        ...
        dismiss();
        onAfterSubmit();
        snackbar.showMessage("Legit Check Detail updated.");
      }
    },
    [dismiss, snackbar, initialValues, onAfterSubmit]
  );
  ...
  return (
    <div>
      <BasicDialog
        ...
        bgClose={!loading}
      >
        <title>Update Legit Check Detail</title>
        <section>
...
export default reduxForm<IFormProps, IComponentProps>({
  form: "updateLegitCheckDetailDialogForm",
